...
def example_execution(env, policy, render=False, stop=False):
    ...
    print(str((n_peatons_run/number_of_simulations)*-10 + (n_dangerous/number_of_simulations)*-3) + "total value of objective 2")
...
if __name__ == "__main__":
    ...
    policy = np.load('new_more_sto/policy_lexunethical0.npy')
